                            ...
                            <div style={{ background:'#F6F6FB' }}>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-xl-7 col-sm-12">
                                        ...
                                        <p className="f12" style={{ color:'#000' }}>Avg. time, Min. time & max. time with threshold</p>
                                            ...
                                            <div className="card-body">
                                                <div className="row">
                                                <div className="col-xl-5 col-sm-12 bold dashboard-gray-color">
                                ...
                                <div className="row">
                                    <div className="col-xl-6 col-sm-6">
                                        ...
                                        <div className="card-body">
                                        <LineChart chart_id={"training_session_vs_day2"} color={"#FF7171"} />
                                        </div>
                                    ...
                                    <div className="col-xl-6 col-sm-6">
                                        ...
                                        <div className="card-body">
                                        <LineChart chart_id={"certificate_session_vs_day2"} color={"#2F53FF"} />
                                        </div>
                                ...
                                <div className="row">
                                    ...
                                    <div className="card br10">
                                        ...
                                        <div className="card-body">
                                          <LineChart chart_id={"threshold_chart"} color={"#2F53FF"} threshold={"yes"}/>
                                        </div>
